...
#otu_table(pseq.soil.1)["Bacteria_Actinobacteriota_Actinobacteria_Micrococcales_Intrasporangiaceae_Phycicoccus"]


### Removing non-variant taxa
#df_vars <- rowVars(otu_table(pseq.soil.1))
#df_vars[df_vars==0]
#variant <- df_vars[df_vars>0] %>% names()
#length(variant)
#pseq.soil.2 = prune_taxa(variant, pseq.soil)
#pseq.soil.2
