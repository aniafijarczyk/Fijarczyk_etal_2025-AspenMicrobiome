...
write.table(dalpha, file="nitro_06_chao_soil.tsv", sep='\t', row.names = FALSE, col.names = TRUE, quote = FALSE, append=FALSE)
...
write.table(df.models, file = "nitro_06_chao_soil_tests.tsv", sep="\t", row.names = F, col.names = T, append=F, quote=F)
...
#png('nitro_06_chao_soil.png', w=800, h=1200, res=300)
#p1C
#dev.off()
