...
write.table(dsub.stands, file="nitro_04_clr_roots.tsv", sep="\t", row.names = F, col.names = T, append=F, quote=F)
...
write.table(df.models, file = "nitro_04_clr_roots_tests.tsv", sep="\t", row.names = F, col.names = T, append=F, quote=F)
...
#png('nitro_04_clr_roots.png', w=800, h=1200, res=300)
#p1C
#dev.off()
