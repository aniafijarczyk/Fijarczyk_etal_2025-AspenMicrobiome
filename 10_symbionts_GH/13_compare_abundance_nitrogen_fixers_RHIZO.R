...
write.table(dsub.stands, file="nitro_04_clr_rhizo.tsv", sep="\t", row.names = F, col.names = T, append=F, quote=F)
...
write.table(df.models, file = "nitro_04_clr_rhizo_tests.tsv", sep="\t", row.names = F, col.names = T, append=F, quote=F)
...
#png('nitro_04_clr_rhizo.png', w=800, h=1200, res=300)
#p1C
#dev.off()
