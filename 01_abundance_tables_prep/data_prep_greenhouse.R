...
otu.file.16s <- "../DATA/PeuplierGH_jan2024/16S/all/PeuplierGH_16S_jan2024.ASV_table_norarefaction_dnNA.tsv"
...
otu.file.its <- "../DATA/PeuplierGH_jan2024/ITS/all/PeuplierGH_ITS_jan2024.ASV_table_norarefaction_dnNA.tsv"
...
save(pseq.16s, pseq.its, pseq.p16s, pseq.pits, file = "AVS_filtered_phyloseq.RData")
